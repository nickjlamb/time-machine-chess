...
and how we know they actually do. A technical companion to
[Time-Machine Chess](https://chess.pharmatools.ai) ([source, MIT](https://github.com/nickjlamb/time-machine-chess)).*
