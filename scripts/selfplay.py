...
def play_game(engine: Maia2Engine) -> chess.pgn.Game:
    """Self-play with resignation adjudication (humans resign; policy nets grind)."""
    board = chess.Board()
    white_low = black_low = 0
    resigned = None
    ...
    result = resigned or board.result(claim_draw=True)
